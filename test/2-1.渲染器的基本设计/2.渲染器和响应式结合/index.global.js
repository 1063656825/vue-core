/*
 * @Author: yutaiqi
 * @Date: 2026-01-25 22:11:10
 * @Description: 文件功能描述
 * @FilePath: /reactivity/test/2-1.渲染器的基本设计/2.渲染器和响应式结合/index.global.js
 * @LastEditTime: 2026-01-25 22:24:09
 * @LastEditors: yutaiqi
 */
(function (global, factory) {
    ...
    class RefImpl {
        constructor(_rawValue, __isShallow) {
            this._rawValue = _rawValue;
            this.__isShallow = __isShallow;
            this.__v_isRef = true;
        ...
        set value(newValue) {
            if (hasChanged(toRaw(newValue), this._rawValue)) {
                ...
                trigger(toRaw(this), "SET" /* TriggerOpTypes.SET */, 'value', newValue);
            }
        }
    }
    class ObjectRefImpl {
    ...
    /*
     * @Author: yutaiqi
     * @Date: 2026-01-25 22:01:46
     * @Description: 文件功能描述
     * @FilePath: /reactivity/src/index.ts
     * @LastEditTime: 2026-01-25 22:11:05
     * @LastEditors: yutaiqi
     */
